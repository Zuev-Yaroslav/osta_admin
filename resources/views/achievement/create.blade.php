...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Добавить достижение</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Добавить достижение</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <form id="achievement-store" action="{{ route('admin.achievement.store') }}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="{{ route('admin.achievement.create') }}" class="btn btn-primary">Создать новый</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
